...
echo '— in a browser —'
for t in speed thread promise record call desk stepper mentorship supervision firms webinars screening drafting work-and-channels auction promo console first-paint account view-as staff-role auth-ui onboarding onboarding-late-session \
