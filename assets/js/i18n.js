...
(function (global) {
  ...
  var DICT = {
    ar: {
      ...
      "ai.lawyerApproved": "مراجعة محامٍ مرخص مشمولة في السعر",
      ...
      /* --- home (trimmed) --- */
      "home.aiTitle": "مسودة بالذكاء الاصطناعي، باعتماد محامٍ",
      "home.aiLead": "المستندات البسيطة لا تحتاج أتعاب صياغة كاملة. اطلبها بسعر يسير، ويظل الاعتماد بيد محامٍ مرخص.",
      "home.aiCta": "اطلب مسودة",
      "home.from": "تبدأ من",
      ...
      "home.heroTitle": "سندك القانوني الموثوق.. خبراء، وذكاء اصطناعي، ومساعدون في خدمتك",
      "home.heroLead": "منصة سعودية تجمع المحامين المعتمدين والمساعدين القانونيين لإنجاز أعمالك وقضاياك بدقة وشفافية.",
    ...
    en: {
      ...
      /* --- home (trimmed) --- */
      "home.aiTitle": "AI-drafted, lawyer-approved",
      "home.aiLead": "Simple documents do not need full drafting fees. Order one at a modest price, with a licensed lawyer still signing it off.",
      "home.aiCta": "Order a draft",
      "home.from": "from",
      ...
      "home.heroTitle": "Your trusted legal backing — experts, AI, and assistants at your service",
      "home.heroLead": "A Saudi platform bringing together licensed lawyers and legal assistants to move your work and cases forward with precision and transparency.",
