...
Pages.define("intern", function (global) {
  ...
  function tabsFor(u) {
    // A public profile, and only that. The trainee's own workspace — who
    // signs for them, the mentor directory, their hours — is mentorship.html:
    // it is not a view of this person for other people to read.
