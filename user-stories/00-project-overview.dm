...
- **US-020 — الدفع والعمولة والضريبة وتوزيع المستحقّات**: غير منفَّذ — البوّابة المختارة ابتداءً: ميسر، وهي قابلة للاستبدال بمُنفِّذ آخر. لا إطلاق تجاري قبل إغلاقها
- **US-021 — الإشعارات والتنبيهات — فجوة معلومة**: غير منفَّذ — فجوة موثَّقة، مطلوبة قبل الإطلاق التجاري
- **US-022 — قبول التسليم والنزاعات وحماية الأطراف**: غير منفَّذ — مطلوب مع الدفع، لا قبله ولا بعده
